...
var connectionString = builder.Configuration.GetConnectionString("MinimalChatDbContextConnection") ?? throw new InvalidOperationException("Connection string 'MinimalChatDbContextConnection' not found.");
...
app.UseEndpoints(endpoints => endpoints.MapHub<MinimalChat.ChatHub>("/Enter"));
